...
const SYSTEMS = [
  { cat: "Forgódobos szárító", title: "DR-12", desc: "Robusztus dobszárító nedves faaprítékhoz és melléktermékhez — nagy áteresztés, stabil kimenet.", group: "Dobszárító", img: PHOTO + "biomass-belt-dryer.png", rate: "12 t/h" },
  { cat: "Forgódobos szárító", title: "DR-24", desc: "Nagy kapacitású dobszárító ipari volumenhez, hőhasznosítással és automatikus szabályzással.", group: "Dobszárító", img: PHOTO + "biomass-belt-dryer.png", rate: "24 t/h" },
  { cat: "Alacsony hőfokú szalagszárító", title: "BD-8", desc: "Szalagszárító hulladékhővel — kíméletes, alacsony hőfokú szárítás pellet- és brikett-alapanyaghoz.", group: "Szalagszárító", img: PHOTO + "biomass-belt-dryer.png", rate: "8 t/h" },
  { cat: "Alacsony hőfokú szalagszárító", title: "BD-16", desc: "Nagyobb felületű szalagszárító folyamatos üzemhez, egyenletes maradék-nedvességgel.", group: "Szalagszárító", img: PHOTO + "biomass-belt-dryer.png", rate: "16 t/h" },
];
  ...
  return (
    <aside style={{ position: "fixed", left: 0, top: 0, bottom: 0, width: "var(--sidebar-w)", background: "var(--color-surface-dark)",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14, alignItems: "center" }}>
        <a href="#" aria-label="info@dobszarito.hu" style={railIconStyle} className="rail-ic"><span style={{width:18,height:18,display:"inline-flex"}}><Mail/></span></a>
    ...
    <header style={{ position: "sticky", top: 0, zIndex: 30, background: "var(--color-header-bg, rgba(255,255,255,0.92))", backdropFilter: "blur(8px)",
      ...
      <span style={{ display: "inline-flex", alignItems: "center", gap: 9 }}>
        ...
        <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 21, letterSpacing: "-0.01em", color: "var(--color-text)" }}>
          dobszarito<span style={{ color: "var(--color-accent-text)" }}>.hu</span>
        </span>
      </span>
...
function Hero({ onQuote }) {
  return (
    <section style={{ position: "relative", minHeight: 560, display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
      <div style={{ position: "absolute", inset: 0, background: `url(${PHOTO}biomass-belt-dryer.png) center/cover` }} />
      ...
      <div style={{ position: "relative", padding: "0 64px 72px", maxWidth: 840 }}>
        <Tag>Biomassza-szárítás</Tag>
        <h1 style={{ color: "#fff", fontSize: 72, lineHeight: 0.98, letterSpacing: "-0.02em", margin: "20px 0 0", fontWeight: 800 }}>
          Szárazabb alapanyag, <span style={{ color: "var(--color-accent)" }}>több energia</span>
        </h1>
        <p style={{ color: "rgba(255,255,255,0.85)", fontSize: 19, lineHeight: 1.55, maxWidth: 640, marginTop: 18 }}>
          Forgódobos és alacsony hőfokú szalagszárítók biomasszához, faaprítékhoz és melléktermékhez — a száraz, egyenletes alapanyag a pellet, a brikett és a hatékony tüzelés feltétele, magyar mérnöki támogatással.
        </p>
        <div style={{ display: "flex", gap: 14, marginTop: 30, flexWrap: "wrap" }}>
          <Button variant="primary" size="lg" iconRight={<ArrowRight/>} onClick={onQuote}>Ajánlatot kérek</Button>
          <Button variant="outline-light" size="lg" iconLeft={<Download/>}>Szárító-katalógus</Button>
        </div>
      </div>
    </section>
  );
...
function Stats() {
  return (
    <section style={{ background: "var(--color-surface-dark)", padding: "40px 64px", display: "flex", gap: 64, flexWrap: "wrap" }}>
      <StatBlock tone="dark" value="24" suffix="t/h" label="csúcskapacitás szárítónként" />
      <StatBlock tone="dark" value="2" label="szárító-típus üzemméret szerint" />
      <StatBlock tone="dark" value="55" suffix="°C" label="alacsony hőfokú szalagszárítás" />
      <StatBlock tone="dark" value="20" suffix="%" label="cél-maradéknedvesség alatt" />
    </section>
  );
}
  ...
  return (
    <section style={{ padding: "72px 64px", maxWidth: 1280, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 24, flexWrap: "wrap", marginBottom: 32 }}>
        <SectionHeading overline="Szárítók" title="Szárító minden biomasszához és volumenhez"
          lead="A nagy áteresztésű forgódobos szárítótól az alacsony hőfokú szalagszárítóig — típus szerint." />
        <div style={{ minWidth: 220 }}>
          <Select label="Szárító-típus" value={filter} onChange={(e) => setFilter(e.target.value)} options={groups} />
        </div>
      </div>
...
function Process() {
  const items = [
    { t: "Egyenletes nedvesség", d: "A kontrollált szárítás stabil, alacsony maradék-nedvességet ad — ez a feltétele a jó brikettnek, pelletnek és a hatékony tüzelésnek." , ic: <Droplet/> },
    { t: "Hulladékhő hasznosítása", d: "A szalagszárító alacsony hőfokon, akár füstgáz- vagy hulló hővel dolgozik — kisebb energiaköltség, jobb mérleg." , ic: <Timer/> },
    { t: "Az értéklánc alapja", d: "A száraz alapanyag teszi lehetővé a brikettálást és pelletálást — a szárítás a feldolgozás kulcslépése." , ic: <Layers/> },
  ];
  return (
    <section style={{ background: "var(--color-bg-subtle)", padding: "72px 64px" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        <SectionHeading align="center" style={{ margin: "0 auto 40px" }} overline="Miért szárítás?"
          title="A feldolgozás kulcslépése" lead="Nem csak szárítót szállítunk — az alapanyaghoz méretezzük, beüzemeljük és életcikluson át támogatjuk." />
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 56, alignItems: "center" }}>
        <div>
          <SectionHeading tone="dark" overline="Kapcsolat" title="Beszéljük át a szárítási feladatát"
            lead="Küldje el az alapanyagot, a belépő nedvességet és a kívánt volument — 24 órán belül szárító-javaslattal és ár-becsléssel jelentkezünk." />
          <div style={{ display: "flex", gap: 14, marginTop: 28, flexWrap: "wrap" }}>
            <ContactPill icon={<Mail/>} href="#">info@dobszarito.hu</ContactPill>
        ...
        <Card padding={28}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            ...
            <Select label="Alapanyag" options={["Faapríték","Fűrészpor","Mezőgazdasági melléktermék","Szennyvíziszap","Egyéb biomassza"]} />
          </div>
          <div style={{ marginTop: 16 }}><Input label="Nedvesség / volumen" placeholder="pl. 50% → 15% · 5 t/h" /></div>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", justifyContent: "space-between", gap: 40, flexWrap: "wrap", alignItems: "flex-start" }}>
        <div style={{ maxWidth: 320 }}>
          <span style={{ display: "inline-flex", alignItems: "center", gap: 9 }}>
            ...
            <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 22, color: "#fff" }}>
              dobszarito<span style={{ color: "var(--color-accent)" }}>.hu</span>
            </span>
          </span>
          <p style={{ marginTop: 14, fontSize: 14, lineHeight: 1.6 }}>Az ECOTEQ biomassza-szárítási üzletága. Forgódobos és szalagszárítók magyar mérnöki támogatással.</p>
        </div>
        <div style={{ display: "flex", gap: 56, flexWrap: "wrap" }}>
          <div>
            ...
            {subs.map((s) => <div key={s} style={{ fontSize: 14, padding: "4px 0", color: s === "dobszarito.hu" ? "var(--color-accent)" : "inherit", fontWeight: s === "dobszarito.hu" ? 700 : 400 }}>{s}</div>)}
          </div>
          <div>
            <div style={{ color: "#fff", fontWeight: 700, fontSize: 13, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 12 }}>Kapcsolat</div>
            <div style={{ fontSize: 14, padding: "4px 0" }}>info@dobszarito.hu</div>
            <div style={{ fontSize: 14, padding: "4px 0" }}>+36 00 000 000</div>
          </div>
        </div>
      </div>
      <div style={{ maxWidth: 1280, margin: "28px auto 0", paddingTop: 20, borderTop: "1px solid rgba(255,255,255,0.1)", fontSize: 13 }}>© 2026 ECOTEQ Kft. — dobszarito.hu — Minden jog fenntartva.</div>
    </footer>
  );
}
        ...
        <div style={{ padding: 24 }}>
          {sent ? (
            ...
            <>
              ...
              <div style={{ marginTop: 14 }}><Select label="Milyen anyaghoz?" options={["Faapríték","Fűrészpor","Mezőgazdasági melléktermék","Szennyvíziszap","Egyéb biomassza"]} /></div>
...
function DobszaritoSite() {
  ...
  const [mode, setMode] = React.useState(() => {
    try { return localStorage.getItem("dobszarito-mode") || "light"; } catch (e) { return "light"; }
  });
  React.useEffect(() => {
    document.documentElement.dataset.mode = mode;
    try { localStorage.setItem("dobszarito-mode", mode); } catch (e) {}
  }, [mode]);
