# ECOTEQ.hu technológiai kapuoldal — Vákuumszárítás v1.1

> **v1.1 — összhangba hozva az „általános szabályok" réteggel (2026-06-21).**
> - CTA-rendszer csere (QA 2.1 §16): „Technológiai irányt/javaslatot kérek" → „Leírom az anyagot és a célt"; űrlap submit → „Elküldöm az alapadatokat".
...
> **Vezető pillér:** Végig ott vagyunk (szerviz) · **Nyitó-archetípus:** Konkrét-anyag · **Tudatossági szint:** megoldás-tudatos · **Primer CTA:** Leírom az anyagot és a célt

## Oldal szerepe

Ez az oldal az ECOTEQ.hu technológiai kapuoldala a faipari vákuumszárítás témára.
...
Vákuumszárítás faanyag kontrollált, gyorsabb és kiszámíthatóbb szárítására. Az ECOTEQ segít eldönteni, hogy az adott faanyaghoz, mennyiséghez, nedvességhez és gyártási célhoz reális-e a vákuumszárító technológia.
...
Másodlagos CTA: **Részletes vákuumszárító oldal megnyitása**

## Microcopy

Nem kell kész gépspecifikációval érkeznie. Elég, ha leírja a fafajt, vastagságot, hosszúságot, induló és cél nedvességet, valamint a havi vagy heti szárítási igényt.
...
Milyen faanyagoknál és helyzetekben merül fel?

## Bevezető copy

A vákuumszárításnál a fafaj, vastagság, hosszúság, induló nedvesség, cél nedvesség és végfelhasználás együtt határozza meg, hogy milyen gépméret és technológiai irány lehet reális.
...
Hogyan épülhet fel egy vákuumszárítási rendszer?

## Bevezető copy

A vákuumszárító kiválasztása nem csak kamraméret kérdése. A rakodás, energiaellátás, kondenzvíz-kezelés, vezérlés, telepítési hely és későbbi üzemeltetés ugyanúgy része a döntésnek.
...
Mire kell figyelni, mielőtt vákuumszárítót választ?
...
Másképp viselkedik a tölgy, bükk, kőris vagy más keményfa. A fafaj meghatározza a technológiai óvatosságot és cikluslogikát.

### Vastagság és hosszúság

A tipikus méretek alapján kell választani kamrahosszt, rakodási módot és kapacitást.

### Induló és cél nedvesség

Nem mindegy, honnan hová kell szárítani az anyagot. A cél nedvesség a végfelhasználástól függ.

### Havi vagy heti mennyiség

A szükséges kapacitást a termelési ritmushoz kell illeszteni, nem egyszeri maximumhoz.

### Energiaellátás

Elektromos kapacitás, fűtési igény, telepítési környezet és üzemeltetési feltételek.

### Minőségi elvárás

Repedés, vetemedés, szín, belső feszültség és feldolgozhatóság szempontjai.
...
Miben segít az ECOTEQ egy vákuumszárítási projektben?
...
### Faanyagalapú előminősítés

Fafaj, vastagság, hossz, mennyiség és nedvességi cél alapján indul a javaslat.

### Technológiai irány

Segítünk eldönteni, hogy vákuumszárítás reális irány-e, és milyen kapacitástartományt érdemes vizsgálni.

### Elismert ISVE vákuumtechnológiai háttér

Az ECOTEQ az ISVE vákuumtechnológiák magyarországi képviselőjeként dolgozik a faipari vákuumtechnológiai területen. *(Konkrét „X éves háttér / X óta" állítás csak validáltan használható: [VALIDÁLANDÓ].)*
...
A vákuumszárítás a faipari vákuumtechnológiai irány egyik fő területe. Egyes projektekben vákuumimpregnálás, gőzölés vagy kapcsolódó anyagmozgatási és telepítési kérdések is felmerülhetnek.

## Kapcsolódó ECOTEQ technológiák

### Vákuumimpregnálás

Ha a faanyag védelme, kezelése vagy speciális impregnálása is cél.

Link: `/technologiak/vakuumimpregnalas/`

### Anyagmozgatás és rendszerelemek

Ha a faanyag rakodása, mozgatása, telepítése vagy kiszolgálása külön figyelmet igényel.

Link: `/technologiak/anyagmozgas-rendszerelemek/`

## Részletes spoke oldal

A részletes vákuumszárító gépválasztó, technológiai magyarázat, ajánlatkérési út és faipari tudástár a vakuumszarito.hu oldalon érhető el.

CTA: **Részletes vákuumszárító oldal megnyitása**
...
Gyakori kérdések a vákuumszárítás kapcsán

### Mikor érdemes vákuumszárítóban gondolkodni?

Akkor, ha a szárítási idő, a faanyag értéke, a minőségi kontroll vagy a gyártási tervezhetőség fontos üzemi kérdés.

### Milyen faanyagnál lehet releváns?

Gyakran keményfáknál és értékesebb faanyagoknál merül fel, de a pontos alkalmasság fafajtól, mérettől és cél nedvességtől függ.

### Mekkora kamra kell?

A jellemző faanyag-hossz, vastagság, mennyiség és termelési ritmus alapján lehet meghatározni.

### Gyorsabb, mint a hagyományos szárítás?

Bizonyos anyagoknál és céloknál rövidebb ciklusok érhetők el, de konkrét időt csak anyagadatok és technológiai egyeztetés alapján szabad ígérni.

### Tudnak konkrét gépet ajánlani?

Igen, de először a fafajt, méretet, mennyiséget, induló és cél nedvességet kell tisztázni.
...
Nem biztos benne, hogy vákuumszárító kell? Ez teljesen normális.
...
```ts
export const vakuumszaritasGateway = {
  slug: "vakuumszaritas",
  title: "Vákuumszárítás",
  metaTitle: "Vákuumszárítás faipari üzemeknek | ECOTEQ",
  metaDescription:
    "Vákuumszárítás faanyag kontrollált, gyorsabb és kiszámíthatóbb szárítására. Az ECOTEQ segít eldönteni, hogy az adott faanyaghoz, mennyiséghez, nedvességhez és gyártási célhoz reális-e a vákuumszárító technológia.",
  primaryCta: {
    label: "Leírom az anyagot és a célt",
    href: "/ajanlatkeres/?tech=vakuumszaritas",
  },
  secondaryCta: {
