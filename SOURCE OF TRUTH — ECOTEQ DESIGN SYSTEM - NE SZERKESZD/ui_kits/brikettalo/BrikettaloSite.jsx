...
const PRESSES = [
  { cat: "CFNielsen · mechanikus", title: "BP5510 MaxX", desc: "Nagy kapacitású mechanikus présgép ipari volumenhez — folyamatos, kiszámítható kimenet.", group: "Ipari", img: PHOTO + "briquetting-line.png", rate: "1 500 kg/h" },
  { cat: "CFNielsen · kompakt", title: "BP3200 Line", desc: "Kompakt ipari sor közepes üzemméretre, teljes automatizálással és csomagolással.", group: "Ipari", img: PHOTO + "briquetting-bpu.webp", rate: "800 kg/h" },
  { cat: "Prodeco · hidraulikus", title: "Eco-Press 75", desc: "Kisüzemi hidraulikus présgép asztalos- és faipari forgácshoz, gyors megtérüléssel.", group: "Kisüzemi", img: PHOTO + "briquetting-line.png", rate: "250 kg/h" },
  { cat: "RUF · hidraulikus", title: "RUF 400", desc: "Tömör, prémium brikett fém- és faiparhoz — kompakt lábnyom, halk üzem.", group: "Kisüzemi", img: PHOTO + "briquetting-bpu.webp", rate: "400 kg/h" },
];
  ...
  return (
    <aside style={{ position: "fixed", left: 0, top: 0, bottom: 0, width: "var(--sidebar-w)", background: "var(--color-surface-dark)",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14, alignItems: "center" }}>
        <a href="#" aria-label="info@brikettalo.hu" style={railIconStyle} className="rail-ic"><span style={{width:18,height:18,display:"inline-flex"}}><Mail/></span></a>
    ...
    <header style={{ position: "sticky", top: 0, zIndex: 30, background: "var(--color-header-bg, rgba(255,255,255,0.92))", backdropFilter: "blur(8px)",
      ...
      <span style={{ display: "inline-flex", alignItems: "center", gap: 9 }}>
        ...
        <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 21, letterSpacing: "-0.01em", color: "var(--color-text)" }}>
          brikettalo<span style={{ color: "var(--color-accent)" }}>.hu</span>
        </span>
      </span>
...
function Hero({ onQuote }) {
  return (
    <section style={{ position: "relative", minHeight: 560, display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
      <div style={{ position: "absolute", inset: 0, background: `url(${PHOTO}hero-briquette-plant.jpg) center/cover` }} />
      ...
      <div style={{ position: "relative", padding: "0 64px 72px", maxWidth: 840 }}>
        <Tag>Brikettálás · CFNielsen · Prodeco · RUF</Tag>
        <h1 style={{ color: "#fff", fontSize: 72, lineHeight: 0.98, letterSpacing: "-0.02em", margin: "20px 0 0", fontWeight: 800 }}>
          A hulladékból <span style={{ color: "var(--color-accent)" }}>tüzelőanyag</span>
        </h1>
        <p style={{ color: "rgba(255,255,255,0.85)", fontSize: 19, lineHeight: 1.55, maxWidth: 640, marginTop: 18 }}>
          Ipari és kisüzemi brikettáló rendszerek faipari forgácsból, mezőgazdasági melléktermékből és biomasszából — Európa vezető présgyártóitól, magyar mérnöki támogatással a tervezéstől az üzemeltetésig.
        </p>
        <div style={{ display: "flex", gap: 14, marginTop: 30, flexWrap: "wrap" }}>
          <Button variant="primary" size="lg" iconRight={<ArrowRight/>} onClick={onQuote}>Ajánlatot kérek</Button>
          <Button variant="outline-light" size="lg" iconLeft={<Download/>}>Présgép-katalógus</Button>
        </div>
      </div>
    </section>
  );
...
function Stats() {
  return (
    <section style={{ background: "var(--color-surface-dark)", padding: "40px 64px", display: "flex", gap: 64, flexWrap: "wrap" }}>
      <StatBlock tone="dark" value="1 500" suffix="kg/h" label="csúcskapacitás présgépenként" />
      <StatBlock tone="dark" value="3" label="vezető présgyártó egy kézből" />
      <StatBlock tone="dark" value="90" suffix="%" label="térfogatcsökkentés brikettálással" />
  ...
  return (
    <section style={{ padding: "72px 64px", maxWidth: 1280, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 24, flexWrap: "wrap", marginBottom: 32 }}>
        <SectionHeading overline="Présgépek" title="Présgép minden üzemmérethez"
          lead="A kisüzemi hidraulikus présgéptől az ipari, teljesen automatizált sorokig — kategória szerint." />
...
function Process() {
  const items = [
    { t: "Energiasűrűség", d: "A laza forgácsból tömör brikett lesz: akár 90%-kal kisebb térfogat, magasabb fűtőérték, tisztább égés." , ic: <Flame/> },
    { t: "Mérnöki kiválasztás", d: "Anyag, nedvesség és volumen alapján méretezzük a présgépet — hogy valóban visszahozza az árát." , ic: <Gauge/> },
  ...
  return (
    <section style={{ background: "var(--color-bg-subtle)", padding: "72px 64px" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        <SectionHeading align="center" style={{ margin: "0 auto 40px" }} overline="Miért brikett?"
          title="A melléktermékből érték" lead="Nem csak présgépet szállítunk — végigvisszük a projektet az anyagvizsgálattól az üzemeltetésig." />
  ...
  return (
    <section style={{ background: "var(--color-surface-dark)", padding: "72px 64px", position: "relative", overflow: "hidden" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 56, alignItems: "center" }}>
        <div>
          <SectionHeading tone="dark" overline="Kapcsolat" title="Beszéljük át a brikett-projektjét"
            lead="Küldje el az alapanyagot és a kívánt volument — 24 órán belül présgép-javaslattal és ár-becsléssel jelentkezünk." />
          <div style={{ display: "flex", gap: 14, marginTop: 28, flexWrap: "wrap" }}>
            <ContactPill icon={<Mail/>} href="#">info@brikettalo.hu</ContactPill>
    ...
    <footer style={{ background: "var(--color-feature-deep, var(--navy-900))", color: "rgba(255,255,255,0.7)", padding: "48px 64px" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", justifyContent: "space-between", gap: 40, flexWrap: "wrap", alignItems: "flex-start" }}>
        <div style={{ maxWidth: 320 }}>
          ...
          <p style={{ marginTop: 14, fontSize: 14, lineHeight: 1.6 }}>Az ECOTEQ brikettálási üzletága. Ipari és kisüzemi présgépek magyar mérnöki támogatással.</p>
        </div>
        <div style={{ display: "flex", gap: 56, flexWrap: "wrap" }}>
          <div>
            ...
            {subs.map((s) => <div key={s} style={{ fontSize: 14, padding: "4px 0", color: s === "brikettalo.hu" ? "var(--color-accent)" : "inherit", fontWeight: s === "brikettalo.hu" ? 700 : 400 }}>{s}</div>)}
          </div>
          <div>
            <div style={{ color: "#fff", fontWeight: 700, fontSize: 13, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 12 }}>Kapcsolat</div>
            <div style={{ fontSize: 14, padding: "4px 0" }}>info@brikettalo.hu</div>
            <div style={{ fontSize: 14, padding: "4px 0" }}>+36 00 000 000</div>
          </div>
        </div>
      </div>
      <div style={{ maxWidth: 1280, margin: "28px auto 0", paddingTop: 20, borderTop: "1px solid rgba(255,255,255,0.1)", fontSize: 13 }}>© 2026 ECOTEQ Kft. — brikettalo.hu — Minden jog fenntartva.</div>
    </footer>
  );
}
        ...
        <div style={{ padding: 24 }}>
          {sent ? (
            <div style={{ textAlign: "center", padding: "24px 0" }}>
              ...
              <p style={{ margin: 0, color: "var(--color-text-secondary)" }}>24 órán belül présgép-javaslattal jelentkezünk.</p>
...
function BrikettaloSite() {
  ...
  const [mode, setMode] = React.useState(() => {
    try { return localStorage.getItem("brikettalo-mode") || "light"; } catch (e) { return "light"; }
  });
  React.useEffect(() => {
    document.documentElement.dataset.mode = mode;
    try { localStorage.setItem("brikettalo-mode", mode); } catch (e) {}
  }, [mode]);
